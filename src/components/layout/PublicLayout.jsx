      ...
      <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#040d07' }}>
        ...
        <nav style={{
          ...
          <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: 12, textDecoration: 'none', flexShrink: 0 }}>
            ...
            <div>
              <div style={{ fontFamily: "'Press Start 2P',monospace", fontSize: 10, color: '#4ade80', textShadow: '2px 2px 0 #052e16', lineHeight: 1 }}>
                RepoLink
              </div>
              <div style={{ fontFamily: "'VT323',monospace", fontSize: 14, color: '#1a4a2e', lineHeight: 1, marginTop: 3 }}>
                AI Repo Analyzer
              </div>
            </div>
          </Link>
          ...
          <div style={{ display: 'flex', gap: 10, flexShrink: 0 }}>
            ...
            <Link to="/signup" className="mc-btn btn-g" style={{ fontSize: 7, padding: '9px 18px' }}>
              ▶ Get Started
            </Link>
          </div>
        ...
        <footer style={{ borderTop: '4px solid #22c55e', background: '#040d07', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ padding: '56px 80px 40px', position: 'relative', zIndex: 2 }}>
