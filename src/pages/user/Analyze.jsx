...
export default function Analyze() {
  ...
  return (
    <>
      ...
      <div style={{ background: '#040d07', minHeight: '100%', padding: '32px', position: 'relative' }}>
        <div className="pg" />
        ...
        <div style={{ maxWidth: 700, margin: '0 auto', position: 'relative', zIndex: 2 }}>
          ...
          {loading ? (
            ...
            <>
              ...
              {/* ── INFO CARDS ── */}
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 14, animation: 'fadeUp 0.45s 0.28s ease both' }}>
