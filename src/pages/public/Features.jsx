...
export default function Features() {
  ...
  return (
    <div style={{ background: '#040d07' }}>
      ...
      {/* ── HERO ── */}
      <section style={{
        padding: '90px 80px 70px', position: 'relative', overflow: 'hidden',
      ...
      {/* ── FEATURE CARDS GRID ── */}
      <section style={{ padding: '90px 80px', position: 'relative', background: '#050f08', overflow: 'hidden' }}>
        <div className="pg" />
      ...
      {/* ── LANGUAGE SUPPORT ── */}
      <section style={{ padding: '90px 80px', background: '#040d07', position: 'relative', overflow: 'hidden' }}>
        <div className="pg" />
        <div className="scanline" />
      ...
      {/* ── CTA ── */}
      <section style={{ padding: '100px 80px', textAlign: 'center', position: 'relative', overflow: 'hidden', background: '#020a05' }}>
        <div className="pg" />
        <div className="scanline" />
