  ...
  return (
    <>
      ...
      <section style={{
        ...
        textAlign: 'center', padding: '120px 40px 0',
      }}>
        <div className="pg" />
        ...
        <div style={{ position:'relative', zIndex:10, maxWidth:880, animation:'fadeUp 0.9s ease both' }}>
          ...
          <div style={{
            ...
            border:'2px solid #22c55e', padding:'8px 22px',
            fontFamily:"'Press Start 2P',monospace", fontSize:8, color:'#4ade80', letterSpacing:2,
            background:'rgba(21,128,61,0.15)',
            boxShadow:'0 0 28px rgba(74,222,128,0.2), 4px 4px 0 #040d07',
          }}>
      ...
      {/* ══════════════ STATS ══════════════ */}
      <section style={{ background:'#071a0c', borderTop:'4px solid #22c55e', borderBottom:'4px solid #22c55e', padding:'70px 60px', position:'relative', overflow:'hidden' }}>
        <div className="pg" />
        {/* Corner deco */}
        <div style={{ position:'absolute', top:12, left:12 }}><DiamondOre size={34} /></div>
        <div style={{ position:'absolute', top:12, right:12 }}><DiamondOre size={34} /></div>
        <div style={{ position:'absolute', bottom:12, left:12 }}><TNTBlock size={30} /></div>
        <div style={{ position:'absolute', bottom:12, right:12 }}><TNTBlock size={30} /></div>
        {/* Corner torches */}
        <Torch style={{ position:'absolute', top:12, left:60 }} />
        <Torch style={{ position:'absolute', top:12, right:60 }} />

        <div data-reveal style={{ textAlign:'center', marginBottom:52 }}>
          <div style={{ fontFamily:"'VT323',monospace", fontSize:22, color:'#1a4a2e', letterSpacing:5 }}>▸ SERVER STATISTICS ◂</div>
        </div>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:22 }}>
          {[
            ...
            <div key={i} data-reveal data-d={`${i+1}`} style={{
              background:'#0d1f12', border:'3px solid #1a4528', padding:'28px 20px',
              textAlign:'center', boxShadow:'5px 5px 0 #040d07',
              transition:'all 0.2s', cursor:'default',
            }}
              onMouseOver={e=>{ e.currentTarget.style.borderColor=s.c; e.currentTarget.style.transform='translate(-3px,-3px)'; e.currentTarget.style.boxShadow=`7px 7px 0 #040d07,0 0 25px ${s.c}44`; }}
      ...
      {/* ══════════════ FEATURES ══════════════ */}
      <section style={{ padding:'100px 60px', position:'relative', overflow:'hidden', background:'#050f08' }}>
        <div className="pg" />
      ...
      {/* ══════════════ HOW IT WORKS ══════════════ */}
      <section style={{ padding:'100px 60px', background:'#040d07', position:'relative', overflow:'hidden' }}>
        <div className="pg" />
        <div className="scanline" />
        <NightSky />
        {/* Torch walls */}
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:44, maxWidth:1000, margin:'0 auto', position:'relative' }}>
          {/* Dotted connector */}
      ...
      {/* ══════════════ SOCIAL PROOF ══════════════ */}
      <section style={{ padding:'80px 60px', background:'#050f08', position:'relative', overflow:'hidden' }}>
        <div className="pg" />
      ...
      {/* ══════════════ CTA ══════════════ */}
      <section style={{ padding:'130px 60px', textAlign:'center', position:'relative', overflow:'hidden', background:'#020a05' }}>
        <div className="pg" />
        <div className="scanline" />
        <NightSky />
